...
```
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-surf-4818
```

A live public deployment of this template is available at [https://quiet-surf-4818.templates.workers.dev](https://quiet-surf-4818.templates.workers.dev)
